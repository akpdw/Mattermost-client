...
/**
 * { "id": "string", "create_at": 0, "update_at": 0, "delete_at": 0, "team_id": "string", "type":
 * "string", "display_name": "string", "name": "string", "header": "string", "purpose": "string",
 * "last_post_at": 0, "total_msg_count": 0, "extra_update_at": 0, "creator_id": "string" }
 */
...
public class Channel extends MatterMostClientObject {
  ...
  public Post sendPost(final String textMessage) {
    return getClient().post("/posts", new PostRequest(channelId(), textMessage, null, null),
        Post.class);
  }
  ...
  public Status delete() {
    ...
    return getClient().delete("/channels/" + getId(), Status.class);
  }
