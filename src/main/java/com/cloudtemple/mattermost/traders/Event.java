...
/**
 * https://api.mattermost.com/#tag/WebSocket { "event": "hello", "data": { "server_version":
 * "3.6.0.1451.1c38da627ebb4e3635677db6939e9195" }, "broadcast":{ "omit_users": null, "user_id":
 * "ay5sq51sebfh58ktrce5ijtcwy", "channel_id": "", "team_id": "" } }
 */
@SuppressWarnings("hiding")
@XmlRootElement
public class Event {
  public String event; // typing posted post_edited post_deleted channel_created channel_deleted
                       // channel_updated channel_viewed direct_added group_added added_to_team
                       // new_user leave_team update_team user_added user_updated user_removed
                       // preference_changed preferences_changed preferences_deleted
                       // ephemeral_message status_change hello webrtc authentication_challenge
                       // reaction_added reaction_removed response emoji_added
